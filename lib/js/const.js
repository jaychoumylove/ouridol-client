...
export default {
	...
	qq_interstitialAd_adUnitId: "05bebe4a9e01cb2bc1cb282e429f2ee2", // 插屏广告id
	...
	API: {
		...
		SPRITE_BG_LIST: 'sprite/sprite_bg_list', // 精灵背景列表
		SPRITE_BG_USE: 'sprite/sprite_bg_use', // 精灵背景使用
		SPRITE_BG_BUY: 'sprite/sprite_bg_buy', // 精灵背景购买
		SPRITE_BG_UNLOCK: 'sprite/sprite_bg_unlock', // 精灵背景解锁
	},
}
